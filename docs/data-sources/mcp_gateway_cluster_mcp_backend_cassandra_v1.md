---
page_title: "instaclustr_mcp_gateway_cluster_mcp_backend_cassandra_v1 Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_cluster_mcp_backend_cassandra_v1 (Data Source)
Configuration for a Cassandra backend.
## Example Usage
```
data "instaclustr_mcp_gateway_cluster_mcp_backend_cassandra_v1" "example" { 

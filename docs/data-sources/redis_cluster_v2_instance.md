...
<ins>Type</ins>: string, read-only<br>
<ins>Constraints</ins>: pattern: `[0-9]+\.[0-9]+\.[0-9]+`<br><br>Version of Redis to run on the cluster. Available versions: <ul> <li>`6.2.11`</li> <li>`7.0.9`</li> </ul><br><br>
*___id___*<br>
<ins>Type</ins>: string, read-only<br>

---
page_title: "instaclustr_mcp_gateway_mcp_tool_http_server_operation_v1_instance Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_mcp_tool_http_server_operation_v1_instance (Data Source)
Configuration for an HTTP Server Operation tool.
## Example Usage
```
data "instaclustr_mcp_gateway_mcp_tool_http_server_operation_v1_instance" "example" { 

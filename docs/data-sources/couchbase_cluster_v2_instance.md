---
page_title: "instaclustr_couchbase_cluster_v2_instance Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_couchbase_cluster_v2_instance (Data Source)
Definition of a managed Couchbase cluster that can be provisioned in Instaclustr.
## Example Usage
```
data "instaclustr_couchbase_cluster_v2_instance" "example" { 

---
page_title: "instaclustr_mcp_gateway_cluster_mcp_virtual_server_v1 Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_cluster_mcp_virtual_server_v1 (Data Source)
Definition of an MCP Gateway virtual server that can be managed.
## Example Usage
```
data "instaclustr_mcp_gateway_cluster_mcp_virtual_server_v1" "example" { 

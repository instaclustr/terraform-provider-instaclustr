---
page_title: "instaclustr_mcp_gateway_mcp_backend_http_server_v1_instance Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_mcp_backend_http_server_v1_instance (Data Source)
HTTP Server backend configuration.
## Example Usage
```
data "instaclustr_mcp_gateway_mcp_backend_http_server_v1_instance" "example" { 

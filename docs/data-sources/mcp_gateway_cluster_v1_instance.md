---
page_title: "instaclustr_mcp_gateway_cluster_v1_instance Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_cluster_v1_instance (Data Source)
Definition of a managed MCP Gateway cluster that can be provisioned in Instaclustr.
## Example Usage
```
data "instaclustr_mcp_gateway_cluster_v1_instance" "example" { 
...
<ins>Type</ins>: string, read-only<br>
<ins>Constraints</ins>: pattern: `[0-9]+\.[0-9]+\.[0-9]+`<br><br>Version of MCP Gateway to run on the cluster. Available versions: <ul> <li>`1.1.0`</li> </ul><br><br>
*___id___*<br>
<ins>Type</ins>: string, read-only<br>
...
*___node_size___*<br>
<ins>Type</ins>: string, read-only<br>
<br>Size of the nodes provisioned in the Data Centre. Available versions: <ul> <li>`1.1.0`</li> </ul><br><br>

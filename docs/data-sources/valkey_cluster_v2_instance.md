...
<ins>Type</ins>: string, read-only<br>
<ins>Constraints</ins>: pattern: `[0-9]+\.[0-9]+\.[0-9]+`<br><br>Version of Valkey to run on the cluster. Available versions: <ul> <li>`7.2.7`</li> <li>`7.2.8`</li> </ul><br><br>

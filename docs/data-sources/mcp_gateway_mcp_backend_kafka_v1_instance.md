---
page_title: "instaclustr_mcp_gateway_mcp_backend_kafka_v1_instance Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_mcp_backend_kafka_v1_instance (Data Source)
Configuration for a Kafka backend.
## Example Usage
```
data "instaclustr_mcp_gateway_mcp_backend_kafka_v1_instance" "example" { 

---
page_title: "instaclustr_mcp_gateway_cluster_mcp_tool_kafka_consume_recent_v1 Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_cluster_mcp_tool_kafka_consume_recent_v1 (Data Source)
Configuration for a Kafka Consume Recent tool.
## Example Usage
```
data "instaclustr_mcp_gateway_cluster_mcp_tool_kafka_consume_recent_v1" "example" { 

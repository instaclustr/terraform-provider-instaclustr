...
<ins>Type</ins>: string, read-only<br>
<ins>Constraints</ins>: allowed values: [ `APACHE_CASSANDRA`, `KAFKA`, `APACHE_ZOOKEEPER`, `KAFKA_CONNECT`, `CADENCE`, `CLICKHOUSE`, `COUCHBASE`, `MONGODB`, `REDIS`, `OPENSEARCH`, `POSTGRESQL`, `UNKNOWN` ]<br><br>

...
<ins>Type</ins>: string, read-only<br>
<ins>Constraints</ins>: allowed values: [ `APACHE_CASSANDRA`, `KAFKA`, `APACHE_ZOOKEEPER`, `KAFKA_CONNECT`, `CADENCE`, `CLICKHOUSE`, `REDIS`, `VALKEY`, `OPENSEARCH`, `POSTGRESQL`, `UNKNOWN` ]<br><br>

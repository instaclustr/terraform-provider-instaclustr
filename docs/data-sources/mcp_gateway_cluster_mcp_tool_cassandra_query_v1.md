---
page_title: "instaclustr_mcp_gateway_cluster_mcp_tool_cassandra_query_v1 Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_cluster_mcp_tool_cassandra_query_v1 (Data Source)
Configuration for a Cassandra Query tool.
## Example Usage
```
data "instaclustr_mcp_gateway_cluster_mcp_tool_cassandra_query_v1" "example" { 

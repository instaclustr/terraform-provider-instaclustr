---
page_title: "instaclustr_mcp_gateway_cluster_mcp_tool_opensearch_index_document_v1 Data Source - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_cluster_mcp_tool_opensearch_index_document_v1 (Data Source)
Configuration for an OpenSearch Index Document tool.
## Example Usage
```
data "instaclustr_mcp_gateway_cluster_mcp_tool_opensearch_index_document_v1" "example" { 

---
page_title: "instaclustr_mcp_gateway_mcp_backend_http_server_v1 Resource - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_mcp_backend_http_server_v1 (Resource)
HTTP Server backend configuration.
## Example Usage
```
resource "instaclustr_mcp_gateway_mcp_backend_http_server_v1" "example" {
...
```
terraform import instaclustr_mcp_gateway_mcp_backend_http_server_v1.[resource-name] "[resource-id]"
```

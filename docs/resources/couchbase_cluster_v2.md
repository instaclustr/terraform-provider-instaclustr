---
page_title: "instaclustr_couchbase_cluster_v2 Resource - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_couchbase_cluster_v2 (Resource)
Definition of a managed Couchbase cluster that can be provisioned in Instaclustr.
## Example Usage
```
resource "instaclustr_couchbase_cluster_v2" "example" {
  data_centre {
    cloud_provider = "AZURE_AZ"
    name = "AZURE_AZ_EAST_US"
    network = "10.0.0.0/16"
    node_size = "COU-DEV-t3.medium-80"
    number_of_nodes = 3
    region = "EAST_US"
  }

  private_network_cluster = false
  name = "MyCouchbaseCluster"
  couchbase_version = "[x.y.z]"
...
*___couchbase_version___*<br>
<ins>Type</ins>: string, required, immutable<br>
<ins>Constraints</ins>: pattern: `[0-9]+\.[0-9]+\.[0-9]+`<br><br>Version of Couchbase to run on the cluster. Available versions: <ul> <li>`7.2.0`</li> </ul><br><br>
...
<br>Total number of Couchbase nodes in the Data Centre.<br><br>
*___region___*<br>
<ins>Type</ins>: string, required, immutable<br>
...
<br>Size of the nodes provisioned in the Data Centre. --AVAILABLE_NODE_SIZES_MARKER_V2_COUCHBASE--<br><br>
*___network___*<br>
<ins>Type</ins>: string, required, immutable<br>
...
```
terraform import instaclustr_couchbase_cluster_v2.[resource-name] "[resource-id]"
```

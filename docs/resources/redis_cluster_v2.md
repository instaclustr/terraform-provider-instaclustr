...
<ins>Type</ins>: string, required, immutable<br>
<ins>Constraints</ins>: pattern: `[0-9]+\.[0-9]+\.[0-9]+`<br><br>Version of Redis to run on the cluster. Available versions: <ul> <li>`6.2.13`</li> <li>`6.2.14`</li> <li>`7.0.12`</li> <li>`7.0.14`</li> </ul><br><br>
*___name___*<br>
<ins>Type</ins>: string, required, immutable<br>

---
page_title: "instaclustr_mcp_gateway_mcp_tool_kafka_consume_recent_v1 Resource - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_mcp_tool_kafka_consume_recent_v1 (Resource)
Configuration for a Kafka Consume Recent tool.
## Example Usage
```
resource "instaclustr_mcp_gateway_mcp_tool_kafka_consume_recent_v1" "example" {
  consume_period = 900
  topics = [ "mcp-topic" ]
...
```
terraform import instaclustr_mcp_gateway_mcp_tool_kafka_consume_recent_v1.[resource-name] "[resource-id]"
```

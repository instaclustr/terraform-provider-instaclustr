---
page_title: "instaclustr_mcp_gateway_mcp_backend_opensearch_v1 Resource - terraform-provider-instaclustr"
subcategory: ""
description: |-
---

# instaclustr_mcp_gateway_mcp_backend_opensearch_v1 (Resource)
Configuration for an OpenSearch backend.
## Example Usage
```
resource "instaclustr_mcp_gateway_mcp_backend_opensearch_v1" "example" {
  virtual_server_id = "b2c3d4e5-f6a7-8901-bcde-f12345678901"
  name = "my-opensearch-backend"
  opensearch_cluster_id = "c3d4e5f6-a7b8-9012-cdef-123456789012"
}
```
## Glossary
...
```
terraform import instaclustr_mcp_gateway_mcp_backend_opensearch_v1.[resource-name] "[resource-id]"
```
